      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-xs hover:border-slate-300 transition-all">
          <div className="flex justify-between items-start">
            <p className="text-[11px] text-slate-500 font-extrabold uppercase tracking-wider">Total Registered Users</p>
            <div className="w-8 h-8 rounded-xl bg-blue-50 text-[#2F6FED] flex items-center justify-center font-bold">
              <Users className="w-4 h-4" />
            </div>
          </div>
          <h3 className="text-3xl font-black text-[#0B1E39] mt-2 tracking-tight">1,248</h3>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-xs hover:border-slate-300 transition-all">
          ...
          <h3 className="text-3xl font-black text-[#2F6FED] mt-2 tracking-tight">1,150</h3>
          <p className="text-[11px] text-slate-500 font-mono font-bold mt-1">₹57,50,000 Verified Volume</p>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-xs hover:border-slate-300 transition-all">
          ...
          <h3 className="text-3xl font-black text-indigo-700 mt-2 tracking-tight">23 Batches</h3>
          <p className="text-[11px] text-indigo-600 font-semibold mt-1">1,150 Total Active Slots</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-amber-50 to-amber-100/60 p-5 rounded-2xl border border-amber-300/80 shadow-xs hover:border-amber-400 transition-all">
          ...
          <h3 className="text-3xl font-black text-amber-800 mt-2 tracking-tight">322 Grams</h3>
